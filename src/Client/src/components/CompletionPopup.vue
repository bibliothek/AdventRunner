                    ...
                    <Transition name="pop">
                        <div id="completion-dialog" v-if="show" class="bg-gradient-to-br from-primary to-secondary rounded-3xl shadow-2xl overflow-hidden transform" :class="{ 'no-animations': takingScreenshot }">
                            ...
                            <div class="p-12 text-center text-primary-content">
                                ...
                                <div class="text-2xl font-semibold mb-8 animate-slide-up animation-delay-100">
                                    You've completed your Adventrunner challenge!
                                </div>

                                <!-- Stats -->
                                <div class="bg-white bg-opacity-20 backdrop-blur-md rounded-2xl p-8 mb-8 animate-slide-up animation-delay-200">
                                    ...
                                    <div v-if="hasVerifiedDistance" class="mt-6 pt-6 border-t border-white border-opacity-30">
                                        <div class="flex items-center justify-center gap-3">
                                            <img src="/strava-icon.png" alt="Strava" class="h-8 w-8">
                                            <span class="text-lg font-semibold">Verified on Strava!</span>
                                        </div>
                                    </div>
                                </div>

                                <!-- Celebration Message -->
                                <div class="text-xl mb-8 animate-slide-up animation-delay-300">
                                    <div class="mb-3">🚀 Look at you go! 🚀</div>
                                ...
                                <div id="completion-action-btns" class="flex gap-4 justify-center animate-slide-up animation-delay-400">
                                    ...
                                    <button
                                        @click="$emit('close')"
                                        class="btn btn-lg bg-white bg-opacity-80 text-primary hover:bg-opacity-90 border-none shadow-lg text-xl px-12"
                                    >
                                        Close
                                    </button>
                                </div>
